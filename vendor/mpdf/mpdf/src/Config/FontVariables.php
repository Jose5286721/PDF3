		...
		$this->defaults = [
			...
			'fontdata' => [
				...
				"montserrat"=>[
					...
					'I' => "Montserrat-RegularItalic.ttf"
				],
				"dejavuserif" => [
					'R' => "DejaVuSerif.ttf",
			...
			'sans_fonts' => ['dejavusanscondensed', 'sans', 'sans-serif', 'cursive', 'fantasy', 'dejavusans', 'freesans', 'liberationsans',
				...
				'franklin', 'franklingothicbook', 'tahoma', 'garuda', 'montserrat','calibri', 'trebuchet', 'lucidagrande', 'microsoftsansserif',
